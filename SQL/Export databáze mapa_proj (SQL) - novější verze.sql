...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Čtv 18. lis 2021, 16:32
...
CREATE TABLE `mesto` (
  `id` int(11) NOT NULL,
  `nazevm` varchar(255) COLLATE utf8_czech_ci NOT NULL
...
INSERT INTO `mesto` (`id`, `nazevm`) VALUES
(67, ''),
(42, 'Babice'),
(34, 'Bánov'),
(7, 'Bílovice'),
...
CREATE TABLE `obor` (
  `id` int(11) NOT NULL,
  `nazevo` varchar(255) COLLATE utf8_czech_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
...
INSERT INTO `obor` (`id`, `nazevo`) VALUES
(2, 'IT'),
(1, 'OA');
...
(1, '127.0.0.1', 'administrator', '$2y$12$WgSKBi14d.CzThLEYxYy9ej9Ghmvl6f0tb0YizLLENxzXBoMe9iqy', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1637248759, 1, 'Admin', 'istrator', 'ADMIN', '0');
